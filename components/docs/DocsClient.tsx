                ...
                <div className="space-y-4">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-zinc-900/50 border border-zinc-800 rounded-xl pl-9 pr-10 py-3
                        ...
                        <>
                            ...
                            {sortedBookmarks.filter((b) => !b.category).length > 0 && (
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        <span className="text-[10px] font-semibold uppercase tracking-widest px-2 py-0.5 rounded border text-zinc-500 bg-zinc-800/50 border-zinc-700">
                                            Other
                                        </span>
                                        <div className="flex-1 h-px bg-zinc-800/60" />
                                    </div>
...
function SearchResultCard({
    ...
    return (
        <div className="group flex items-start gap-3 p-3.5 bg-zinc-900/40 border border-zinc-800
                    rounded-xl hover:border-zinc-700 hover:bg-zinc-900/70 transition-all">
    ...
    return (
        <div className="group flex items-start gap-3 p-3.5 bg-zinc-900/40 border border-zinc-800
            ...
            <div className="flex items-center gap-1 shrink-0 mt-0.5">
                ...
                <button
                    onClick={onRemove}
                    className="p-1.5 rounded-lg text-zinc-700 hover:text-rose-400 hover:bg-rose-400/10 transition-all"
                    title="Remove"
                >
                    <Trash2 size={13} />
                </button>
